...
public class ProgramTestTryCatch{
...
*/
		...
		try {
			...
			// substituido pelo toString padrão acima
			...
			// substituido pelo toString específico do stringPerimetroQuadrado acima
			// System.out.println("O quadrado com lado A: " + ((Quadrilatero)
		 ...
		 * ladoB = sc.nextDouble(); FiguraGeometrica retangulo = new
